...
export default class Repair extends Phaser.Scene {
  constructor() {
    ...
    this.log5 =
      "I should be able to find PARTS in BOXES around the FACILITY to aid in REPAIRS.";
  }
  ...
  create() {
    ...
    setTimeout(() => {
      this.add.text(50, 100, this.log2, { fontSize: "18px" });
    }, 250);

    setTimeout(() => {
      this.add.text(50, 130, this.log3, { fontSize: "18px" });
    }, 1100);

    setTimeout(() => {
      this.add.text(50, 160, this.log4, { fontSize: "18px" });
    }, 2000);

    setTimeout(() => {
      this.add.text(50, 190, this.log5, { fontSize: "18px" });
    }, 3000);
