...
export default class Loading extends Phaser.Scene {
  ...
  create() {
    this.add.text(50, 50, "Chamaelet Reflora unit coming online...", {
      fontSize: "26px"
    });

    setTimeout(() => {
      this.add.text(50, 80, "Complete! Restoring most recent log entry...", {
        fontSize: "20px"
      });
    }, 750);

    setTimeout(() => {
      this.add.text(50, 110, this.log1, { fontSize: "18px" });
    }, 1500);

    setTimeout(() => {
      this.add.text(50, 140, this.log2, { fontSize: "18px" });
    }, 2250);

    setTimeout(() => {
      this.add.text(50, 170, this.log3, { fontSize: "18px" });
    }, 3000);

    setTimeout(() => {
      this.add.text(50, 200, this.log4, { fontSize: "18px" });
    }, 3750);

    setTimeout(() => {
      this.add.text(50, 230, this.log5, { fontSize: "18px" });
    }, 4500);

    setTimeout(() => {
      this.add.text(50, 260, this.log6, { fontSize: "18px" });
    }, 5250);

    setTimeout(() => {
      this.add.text(50, 290, this.log7, { fontSize: "18px" });
    }, 6000);

    setTimeout(() => {
      this.add.text(50, 320, this.log8, { fontSize: "18px" });
    }, 6750);

    setTimeout(() => {
      this.add.text(50, 350, this.log9, { fontSize: "18px" });
    }, 7500);

    setTimeout(() => {
      this.add.text(50, 380, this.log10, { fontSize: "18px" });
    }, 8250);
